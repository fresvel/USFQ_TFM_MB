...
| **D2** | Enterovirus (poliovirus) | `05_discusion.tex:23` | DIS-ENT-* | **Lote 2** | P4 + glue interpretativo | «Ninguna de las 22 muestras rindió poliovirus… en Eslovaquia… En Canadá, en 2022… 99,4 %… 99,0 %… Seo…» | 🔁 v3 aplicada (registro reporte + voz del autor anclada a n=9%/flujo/PTAR). **Audit MSP_2023: Ecuador usa bOPV oral, NO vacuna inactivada** → corregido claim falso; excreción Sabin anclada a MasLago. Pendiente Turnitin |
