...
| **D4** | Conservación de muestras retrospectivas | `05_discusion.tex:29–31` (encabezado + párrafo) | DIS-CONS-* | anterior (`210786e`) | P2 | «Conservación de muestras retrospectivas como factor crítico. Las ocho muestras retrospectivas, conservadas en DNA/RNA Shield 2X…» | 🔁 v2: termina en dato específico + atribución MejiaCalle; **la recomendación (generalización) queda en Conclusiones C3**, no en Discusión. Pendiente Turnitin |
